    ...
    <div className="w-[448px] rounded overflow-hidden">
      ...
      <div className="divide-y-2 divide-zinc-500 dark:divide-zinc-950">
        ...
        <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
          <Rocket className="w-6 h-6 text-violet-500 mt-3"></Rocket>
          <div className="flex-1 flex flex-col gap-2">
            <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-100">Você recebeu um convite para fazer parte da empresa Rocketseat</p>
            <div className="text-xxs text-zinc-500 dark:text-zinc-400 flex items-center gap-1">
              <span>Convite</span>
              <span>Há 3 min</span>
            </div>
      ...
      <div className="divide-y-2 divide-zinc-500 dark:divide-zinc-950">
        <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
          <Rocket className="w-6 h-6 text-violet-500 mt-3"></Rocket>
          <div className="flex-1 flex flex-col gap-2">
            <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">Você recebeu um convite para fazer parte da empresa Rocketseat</p>
            <div className="text-xxs text-zinc-500 dark:text-zinc-400 flex items-center gap-1">
              <span>Convite</span>
              <span>Há 3 min</span>
            </div>
